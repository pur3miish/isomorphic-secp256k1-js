 ...
 */
export function number_to_array(number: bigint | number): Uint8Array {
 ...
 * console.log(number); // 123456789n
 */
export function array_to_number(array: Uint8Array): bigint {
  return BigInt(
    `0x${array.reduce(
...
export const powmod = (number: bigint, exponent: bigint, m: bigint) => {
  let r = 1n;
  let b = number % m;
  let e = exponent;
...
export function get_mod(val: bigint, mod: bigint): bigint {
 ...
 */
export function mul_inverse(val: bigint, mod: bigint): bigint {
  let dst, t, q;
  let b = mod;
...
export function calc_new_point(
  Q: Point,
  P: Point,
  λ: bigint,
  mod: bigint
...
export function add(Q: Point, P: Point, mod: bigint): Point {
...
export function dbl(G: Point, mod: bigint): Point {
...
export function double_and_add(
  G: Point,
  k: bigint,
  mod: bigint,
  n: bigint
...
export function point_from_x(odd: bigint, x: bigint): Point {
...
export async function get_signature(
  ...
  async function update_T({ buf_h2b, buf_F }: SignBuffers): Promise<bigint> {
